...
<html lang="pt-BR">
    <head>
        ...
        <meta name="description" content="Chatbot feito especialmente para o projeto da uni9" />
        <meta name="author" content="Geronimo Olanda" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Treino Hard</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php">Pagina Inicial</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="./Assets/src/bot.php">Tire suas duvidas aqui</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">TREINE HOJE, E VIVA MAIS SAUDAVEL!</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">TREINOS OFERECIDOS</h2>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">A Treino Hard é uma academia que tem como foco o desenvolvimento fisico e também pessoal dos nossos alunos, desenvolvendo treinos para alcançar o seu objetivo com 100% de aproveitamento e saude!.</p></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h4 class="text-uppercase mb-4">Localidade</h4>
                        <p class="lead mb-0">
                            Av. Brasil São Paulo, Brasil
                            <br />
                            Cep: 09532568
                        </p>
                    </div>
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Sobre a Academia</h4>
                        <p class="lead mb-0">
                            A academia oferece um espaço ambiental para conversação pré e pos treino, com dicas e assuntos de todos os interesses.
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright © Treino Hard 2020</small></div>
        </div>
